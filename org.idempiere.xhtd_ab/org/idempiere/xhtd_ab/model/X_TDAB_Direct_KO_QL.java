...
/** Generated Model for TDAB_Direct_KO_QL
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_TDAB_Direct_KO_QL extends PO implements I_TDAB_Direct_KO_QL, I_Persistent 
{
    ...
    public X_TDAB_Direct_KO_QL (Properties ctx, int TDAB_Direct_KO_QL_ID, String trxName)
    {
      super (ctx, TDAB_Direct_KO_QL_ID, trxName);
      /** if (TDAB_Direct_KO_QL_ID == 0)
        {
			setTDAB_Direct_KO_QL_ID (0);
			setTDAB_Direct_KO_QL_UU (null);
        } */
    }

    /** Load Constructor */
    public X_TDAB_Direct_KO_QL (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TDAB_Direct_KO_QL[")
	...
	/** Set TDAB_Direct_KO_QL_UU.
		@param TDAB_Direct_KO_QL_UU TDAB_Direct_KO_QL_UU	  */
	public void setTDAB_Direct_KO_QL_UU (String TDAB_Direct_KO_QL_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TDAB_Direct_KO_QL_UU, TDAB_Direct_KO_QL_UU);
	}

	/** Get TDAB_Direct_KO_QL_UU.
		@return TDAB_Direct_KO_QL_UU	  */
	public String getTDAB_Direct_KO_QL_UU () 
	{
		return (String)get_Value(COLUMNNAME_TDAB_Direct_KO_QL_UU);
	}
