...
/** Generated Model for TDAB_Financial_Info_History
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_TDAB_Financial_Info_History extends PO implements I_TDAB_Financial_Info_History, I_Persistent 
{
    ...
    public X_TDAB_Financial_Info_History (Properties ctx, int TDAB_Financial_Info_History_ID, String trxName)
    {
      super (ctx, TDAB_Financial_Info_History_ID, trxName);
      /** if (TDAB_Financial_Info_History_ID == 0)
        {
			setTDAB_Financial_Info_History_ID (0);
			setTDAB_Financial_Info_History_UU (null);
        } */
    }

    /** Load Constructor */
    public X_TDAB_Financial_Info_History (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TDAB_Financial_Info_History[")
	...
	/** Set TDAB_Financial_Info_History.
		@param TDAB_Financial_Info_History_ID TDAB_Financial_Info_History	  */
	public void setTDAB_Financial_Info_History_ID (int TDAB_Financial_Info_History_ID)
	{
		if (TDAB_Financial_Info_History_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_TDAB_Financial_Info_History_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_TDAB_Financial_Info_History_ID, Integer.valueOf(TDAB_Financial_Info_History_ID));
	}

	/** Get TDAB_Financial_Info_History.
		@return TDAB_Financial_Info_History	  */
	public int getTDAB_Financial_Info_History_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_TDAB_Financial_Info_History_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set TDAB_Financial_Info_History_UU.
		@param TDAB_Financial_Info_History_UU TDAB_Financial_Info_History_UU	  */
	public void setTDAB_Financial_Info_History_UU (String TDAB_Financial_Info_History_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TDAB_Financial_Info_History_UU, TDAB_Financial_Info_History_UU);
	}

	/** Get TDAB_Financial_Info_History_UU.
		@return TDAB_Financial_Info_History_UU	  */
	public String getTDAB_Financial_Info_History_UU () 
	{
		return (String)get_Value(COLUMNNAME_TDAB_Financial_Info_History_UU);
	}

	public I_TDAB_Financial_Info getTDAB_Financial_Info() throws RuntimeException
    {
		return (I_TDAB_Financial_Info)MTable.get(getCtx(), I_TDAB_Financial_Info.Table_Name)
			.getPO(getTDAB_Financial_Info_ID(), get_TrxName());	}
