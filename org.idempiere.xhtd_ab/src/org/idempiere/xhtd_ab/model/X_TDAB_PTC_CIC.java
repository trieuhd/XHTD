...
/** Generated Model for TDAB_PTC_CIC
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_TDAB_PTC_CIC extends PO implements I_TDAB_PTC_CIC, I_Persistent 
{
    ...
    public X_TDAB_PTC_CIC (Properties ctx, int TDAB_PTC_CIC_ID, String trxName)
    {
      super (ctx, TDAB_PTC_CIC_ID, trxName);
      /** if (TDAB_PTC_CIC_ID == 0)
        {
			setTDAB_PTC_CIC_ID (0);
			setTDAB_PTC_CIC_UU (null);
        } */
    }

    /** Load Constructor */
    public X_TDAB_PTC_CIC (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TDAB_PTC_CIC[")
	...
	/** Set TDAB_PTC_CIC_UU.
		@param TDAB_PTC_CIC_UU TDAB_PTC_CIC_UU	  */
	public void setTDAB_PTC_CIC_UU (String TDAB_PTC_CIC_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TDAB_PTC_CIC_UU, TDAB_PTC_CIC_UU);
	}

	/** Get TDAB_PTC_CIC_UU.
		@return TDAB_PTC_CIC_UU	  */
	public String getTDAB_PTC_CIC_UU () 
	{
		return (String)get_Value(COLUMNNAME_TDAB_PTC_CIC_UU);
	}
