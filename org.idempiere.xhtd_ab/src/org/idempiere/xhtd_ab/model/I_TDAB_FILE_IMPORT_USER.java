...
/** Generated Interface for TDAB_FILE_IMPORT_USER
 *  @author iDempiere (generated) 
 *  @version Release 6.2
 */
@SuppressWarnings("all")
public interface I_TDAB_FILE_IMPORT_USER 
{

    /** TableName=TDAB_FILE_IMPORT_USER */
    public static final String Table_Name = "TDAB_FILE_IMPORT_USER";
    ...
    public static final String COLUMNNAME_Error_Log = "Error_Log";
    ...
    /** Column name TDAB_FILE_IMPORT_ID */
    public static final String COLUMNNAME_TDAB_FILE_IMPORT_ID = "TDAB_FILE_IMPORT_ID";
    ...
    /** Column name TDAB_FILE_IMPORT_USER_ID */
    public static final String COLUMNNAME_TDAB_FILE_IMPORT_USER_ID = "TDAB_FILE_IMPORT_USER_ID";
    ...
    /** Column name TDAB_FILE_IMPORT_USER_UU */
    public static final String COLUMNNAME_TDAB_FILE_IMPORT_USER_UU = "TDAB_FILE_IMPORT_USER_UU";
