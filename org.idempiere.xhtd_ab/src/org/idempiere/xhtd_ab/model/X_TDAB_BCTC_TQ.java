...
/** Generated Model for TDAB_BCTC_TQ
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_TDAB_BCTC_TQ extends PO implements I_TDAB_BCTC_TQ, I_Persistent 
{
    ...
    public X_TDAB_BCTC_TQ (Properties ctx, int TDAB_BCTC_TQ_ID, String trxName)
    {
      super (ctx, TDAB_BCTC_TQ_ID, trxName);
      /** if (TDAB_BCTC_TQ_ID == 0)
        {
			setTDAB_BCTC_TQ_ID (0);
			setTDAB_BCTC_TQ_UU (null);
        } */
    }

    /** Load Constructor */
    public X_TDAB_BCTC_TQ (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TDAB_BCTC_TQ[")
	...
	/** Set TDAB_BCTC_TQ_UU.
		@param TDAB_BCTC_TQ_UU TDAB_BCTC_TQ_UU	  */
	public void setTDAB_BCTC_TQ_UU (String TDAB_BCTC_TQ_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TDAB_BCTC_TQ_UU, TDAB_BCTC_TQ_UU);
	}

	/** Get TDAB_BCTC_TQ_UU.
		@return TDAB_BCTC_TQ_UU	  */
	public String getTDAB_BCTC_TQ_UU () 
	{
		return (String)get_Value(COLUMNNAME_TDAB_BCTC_TQ_UU);
	}
