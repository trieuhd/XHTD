...
/** Generated Model for TDAB_Point_Rate
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_TDAB_Point_Rate extends PO implements I_TDAB_Point_Rate, I_Persistent 
{
    ...
    public X_TDAB_Point_Rate (Properties ctx, int TDAB_Point_Rate_ID, String trxName)
    {
      super (ctx, TDAB_Point_Rate_ID, trxName);
      /** if (TDAB_Point_Rate_ID == 0)
        {
			setTDAB_Point_Rate_ID (0);
			setTDAB_Point_Rate_UU (null);
        } */
    }

    /** Load Constructor */
    public X_TDAB_Point_Rate (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TDAB_Point_Rate[")
	...
	/** Set TDAB_Point_Rate_UU.
		@param TDAB_Point_Rate_UU TDAB_Point_Rate_UU	  */
	public void setTDAB_Point_Rate_UU (String TDAB_Point_Rate_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TDAB_Point_Rate_UU, TDAB_Point_Rate_UU);
	}

	/** Get TDAB_Point_Rate_UU.
		@return TDAB_Point_Rate_UU	  */
	public String getTDAB_Point_Rate_UU () 
	{
		return (String)get_Value(COLUMNNAME_TDAB_Point_Rate_UU);
	}
