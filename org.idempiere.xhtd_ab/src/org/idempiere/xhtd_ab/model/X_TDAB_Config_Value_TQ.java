...
/** Generated Model for TDAB_Config_Value_TQ
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_TDAB_Config_Value_TQ extends PO implements I_TDAB_Config_Value_TQ, I_Persistent 
{
    ...
    public X_TDAB_Config_Value_TQ (Properties ctx, int TDAB_Config_Value_TQ_ID, String trxName)
    {
      super (ctx, TDAB_Config_Value_TQ_ID, trxName);
      /** if (TDAB_Config_Value_TQ_ID == 0)
        {
			setTDAB_Config_Value_TQ_ID (0);
			setTDAB_Config_Value_TQ_UU (null);
        } */
    }

    /** Load Constructor */
    public X_TDAB_Config_Value_TQ (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TDAB_Config_Value_TQ[")
	...
	/** Set TDAB_Config_Value_TQ_UU.
		@param TDAB_Config_Value_TQ_UU TDAB_Config_Value_TQ_UU	  */
	public void setTDAB_Config_Value_TQ_UU (String TDAB_Config_Value_TQ_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TDAB_Config_Value_TQ_UU, TDAB_Config_Value_TQ_UU);
	}

	/** Get TDAB_Config_Value_TQ_UU.
		@return TDAB_Config_Value_TQ_UU	  */
	public String getTDAB_Config_Value_TQ_UU () 
	{
		return (String)get_Value(COLUMNNAME_TDAB_Config_Value_TQ_UU);
	}
