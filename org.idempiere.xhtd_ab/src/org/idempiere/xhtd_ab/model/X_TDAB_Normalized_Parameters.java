...
/** Generated Model for TDAB_Normalized_Parameters
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_TDAB_Normalized_Parameters extends PO implements I_TDAB_Normalized_Parameters, I_Persistent 
{
    ...
    public X_TDAB_Normalized_Parameters (Properties ctx, int TDAB_Normalized_Parameters_ID, String trxName)
    {
      super (ctx, TDAB_Normalized_Parameters_ID, trxName);
      /** if (TDAB_Normalized_Parameters_ID == 0)
        {
			setTDAB_Normalized_Parameters_ID (0);
			setTDAB_Normalized_Parameters_UU (null);
        } */
    }

    /** Load Constructor */
    public X_TDAB_Normalized_Parameters (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TDAB_Normalized_Parameters[")
	...
	/** Set TDAB_Normalized_Parameters_UU.
		@param TDAB_Normalized_Parameters_UU TDAB_Normalized_Parameters_UU	  */
	public void setTDAB_Normalized_Parameters_UU (String TDAB_Normalized_Parameters_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TDAB_Normalized_Parameters_UU, TDAB_Normalized_Parameters_UU);
	}

	/** Get TDAB_Normalized_Parameters_UU.
		@return TDAB_Normalized_Parameters_UU	  */
	public String getTDAB_Normalized_Parameters_UU () 
	{
		return (String)get_Value(COLUMNNAME_TDAB_Normalized_Parameters_UU);
	}
	...
	public void setUser_Checked_ID (int User_Checked_ID)
	{
		if (User_Checked_ID < 1) 
			set_Value (COLUMNNAME_User_Checked_ID, null);
		else 
			set_Value (COLUMNNAME_User_Checked_ID, Integer.valueOf(User_Checked_ID));
	}
