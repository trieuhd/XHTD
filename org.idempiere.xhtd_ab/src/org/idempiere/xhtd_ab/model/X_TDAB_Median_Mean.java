...
/** Generated Model for TDAB_Median_Mean
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_TDAB_Median_Mean extends PO implements I_TDAB_Median_Mean, I_Persistent 
{
    ...
    public X_TDAB_Median_Mean (Properties ctx, int TDAB_Median_Mean_ID, String trxName)
    {
      super (ctx, TDAB_Median_Mean_ID, trxName);
      /** if (TDAB_Median_Mean_ID == 0)
        {
			setTDAB_Median_Mean_ID (0);
			setTDAB_Median_Mean_UU (null);
        } */
    }

    /** Load Constructor */
    public X_TDAB_Median_Mean (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TDAB_Median_Mean[")
	...
	/** Set TDAB_Median_Mean_UU.
		@param TDAB_Median_Mean_UU TDAB_Median_Mean_UU	  */
	public void setTDAB_Median_Mean_UU (String TDAB_Median_Mean_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TDAB_Median_Mean_UU, TDAB_Median_Mean_UU);
	}

	/** Get TDAB_Median_Mean_UU.
		@return TDAB_Median_Mean_UU	  */
	public String getTDAB_Median_Mean_UU () 
	{
		return (String)get_Value(COLUMNNAME_TDAB_Median_Mean_UU);
	}
