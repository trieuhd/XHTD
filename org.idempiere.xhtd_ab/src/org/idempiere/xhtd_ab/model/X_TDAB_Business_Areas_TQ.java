...
/** Generated Model for TDAB_Business_Areas_TQ
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_TDAB_Business_Areas_TQ extends PO implements I_TDAB_Business_Areas_TQ, I_Persistent 
{
    ...
    public X_TDAB_Business_Areas_TQ (Properties ctx, int TDAB_Business_Areas_TQ_ID, String trxName)
    {
      super (ctx, TDAB_Business_Areas_TQ_ID, trxName);
      /** if (TDAB_Business_Areas_TQ_ID == 0)
        {
			setTDAB_Business_Areas_TQ_ID (0);
			setTDAB_Business_Areas_TQ_UU (null);
        } */
    }

    /** Load Constructor */
    public X_TDAB_Business_Areas_TQ (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TDAB_Business_Areas_TQ[")
	...
	/** Set TDAB_Business_Areas_TQ_UU.
		@param TDAB_Business_Areas_TQ_UU TDAB_Business_Areas_TQ_UU	  */
	public void setTDAB_Business_Areas_TQ_UU (String TDAB_Business_Areas_TQ_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TDAB_Business_Areas_TQ_UU, TDAB_Business_Areas_TQ_UU);
	}

	/** Get TDAB_Business_Areas_TQ_UU.
		@return TDAB_Business_Areas_TQ_UU	  */
	public String getTDAB_Business_Areas_TQ_UU () 
	{
		return (String)get_Value(COLUMNNAME_TDAB_Business_Areas_TQ_UU);
	}
