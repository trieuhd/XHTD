...
/** Generated Model for TDAB_Logistic
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_TDAB_Logistic extends PO implements I_TDAB_Logistic, I_Persistent 
{
    ...
    public X_TDAB_Logistic (Properties ctx, int TDAB_Logistic_ID, String trxName)
    {
      super (ctx, TDAB_Logistic_ID, trxName);
      /** if (TDAB_Logistic_ID == 0)
        {
			setTDAB_Logistic_ID (0);
			setTDAB_Logistic_UU (null);
        } */
    }

    /** Load Constructor */
    public X_TDAB_Logistic (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TDAB_Logistic[")
	...
	/** Set TDAB_Logistic_UU.
		@param TDAB_Logistic_UU TDAB_Logistic_UU	  */
	public void setTDAB_Logistic_UU (String TDAB_Logistic_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TDAB_Logistic_UU, TDAB_Logistic_UU);
	}

	/** Get TDAB_Logistic_UU.
		@return TDAB_Logistic_UU	  */
	public String getTDAB_Logistic_UU () 
	{
		return (String)get_Value(COLUMNNAME_TDAB_Logistic_UU);
	}
