...
/** Generated Model for TDAB_BCTC_DN_B1
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_TDAB_BCTC_DN_B1 extends PO implements I_TDAB_BCTC_DN_B1, I_Persistent 
{
    ...
    public X_TDAB_BCTC_DN_B1 (Properties ctx, int TDAB_BCTC_DN_B1_ID, String trxName)
    {
      super (ctx, TDAB_BCTC_DN_B1_ID, trxName);
      /** if (TDAB_BCTC_DN_B1_ID == 0)
        {
			setBCTC_B1_File (null);
			setTDAB_BCTC_DN_B1_ID (0);
			setTDAB_BCTC_DN_B1_UU (null);
        } */
    }

    /** Load Constructor */
    public X_TDAB_BCTC_DN_B1 (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TDAB_BCTC_DN_B1[")
	...
	/** Set TDAB_BCTC_DN_B1_ID.
		@param TDAB_BCTC_DN_B1_ID TDAB_BCTC_DN_B1_ID	  */
	public void setTDAB_BCTC_DN_B1_ID (int TDAB_BCTC_DN_B1_ID)
	{
		if (TDAB_BCTC_DN_B1_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_TDAB_BCTC_DN_B1_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_TDAB_BCTC_DN_B1_ID, Integer.valueOf(TDAB_BCTC_DN_B1_ID));
	}

	/** Get TDAB_BCTC_DN_B1_ID.
		@return TDAB_BCTC_DN_B1_ID	  */
	public int getTDAB_BCTC_DN_B1_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_TDAB_BCTC_DN_B1_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set TDAB_BCTC_DN_B1_UU.
		@param TDAB_BCTC_DN_B1_UU TDAB_BCTC_DN_B1_UU	  */
	public void setTDAB_BCTC_DN_B1_UU (String TDAB_BCTC_DN_B1_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TDAB_BCTC_DN_B1_UU, TDAB_BCTC_DN_B1_UU);
	}

	/** Get TDAB_BCTC_DN_B1_UU.
		@return TDAB_BCTC_DN_B1_UU	  */
	public String getTDAB_BCTC_DN_B1_UU () 
	{
		return (String)get_Value(COLUMNNAME_TDAB_BCTC_DN_B1_UU);
	}
