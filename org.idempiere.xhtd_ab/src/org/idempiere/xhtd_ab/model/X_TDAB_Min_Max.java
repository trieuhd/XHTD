...
/** Generated Model for TDAB_Min_Max
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_TDAB_Min_Max extends PO implements I_TDAB_Min_Max, I_Persistent 
{
    ...
    public X_TDAB_Min_Max (Properties ctx, int TDAB_Min_Max_ID, String trxName)
    {
      super (ctx, TDAB_Min_Max_ID, trxName);
      /** if (TDAB_Min_Max_ID == 0)
        {
			setTDAB_Min_Max_ID (0);
			setTDAB_Min_Max_UU (null);
        } */
    }

    /** Load Constructor */
    public X_TDAB_Min_Max (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TDAB_Min_Max[")
	...
	/** Set TDAB_Min_Max_UU.
		@param TDAB_Min_Max_UU TDAB_Min_Max_UU	  */
	public void setTDAB_Min_Max_UU (String TDAB_Min_Max_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TDAB_Min_Max_UU, TDAB_Min_Max_UU);
	}

	/** Get TDAB_Min_Max_UU.
		@return TDAB_Min_Max_UU	  */
	public String getTDAB_Min_Max_UU () 
	{
		return (String)get_Value(COLUMNNAME_TDAB_Min_Max_UU);
	}
