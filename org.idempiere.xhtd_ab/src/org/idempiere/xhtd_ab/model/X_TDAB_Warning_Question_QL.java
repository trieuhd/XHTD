...
/** Generated Model for TDAB_Warning_Question_QL
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_TDAB_Warning_Question_QL extends PO implements I_TDAB_Warning_Question_QL, I_Persistent 
{
    ...
    public X_TDAB_Warning_Question_QL (Properties ctx, int TDAB_Warning_Question_QL_ID, String trxName)
    {
      super (ctx, TDAB_Warning_Question_QL_ID, trxName);
      /** if (TDAB_Warning_Question_QL_ID == 0)
        {
			setTDAB_Warning_Question_QL_ID (0);
			setTDAB_Warning_Question_QL_UU (null);
        } */
    }

    /** Load Constructor */
    public X_TDAB_Warning_Question_QL (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TDAB_Warning_Question_QL[")
	...
	/** Set TDAB_Warning_Question_QL_UU.
		@param TDAB_Warning_Question_QL_UU TDAB_Warning_Question_QL_UU	  */
	public void setTDAB_Warning_Question_QL_UU (String TDAB_Warning_Question_QL_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TDAB_Warning_Question_QL_UU, TDAB_Warning_Question_QL_UU);
	}

	/** Get TDAB_Warning_Question_QL_UU.
		@return TDAB_Warning_Question_QL_UU	  */
	public String getTDAB_Warning_Question_QL_UU () 
	{
		return (String)get_Value(COLUMNNAME_TDAB_Warning_Question_QL_UU);
	}
